...
public class ChangeGameModeEventSystem extends EntityEventSystem<EntityStore, ChangeGameModeEvent> {

    public ChangeGameModeEventSystem() {
    ...
    public void handle(int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk,
        ...
        if (plugin != null) plugin.log(Level.INFO, "[ChangeGameMode] declenche !");
    }
