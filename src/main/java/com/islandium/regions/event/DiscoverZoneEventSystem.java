...
public class DiscoverZoneEventSystem extends EntityEventSystem<EntityStore, DiscoverZoneEvent> {

    public DiscoverZoneEventSystem() {
    ...
    public void handle(int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk,
                       ...
                       @Nonnull DiscoverZoneEvent event) {
        RegionsPlugin plugin = RegionsPlugin.get();
        if (plugin != null) plugin.log(Level.INFO, "[DiscoverZone] declenche !");
    }
